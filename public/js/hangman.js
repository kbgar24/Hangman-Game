...
var Hangman = {
    words:            [dog, cat, fish, bird], // Set of words for hangman to choose from
     ...
     */
    pickWord: function() { 
        wordRandomizer = Math.floor(Math.random()*(this.words.length + 1));
    ...
    isLetterInWord: function(letter) {
        var inputLetter = $("#inputButton").click(function(){
